...
`
  ...
  //
  // test with $extend and $extendR
  describe('test with $extend', function() {
    ...
    it('basic $extend', function() {
      ...
      expect(ret.css).equal(`p,div {
color: 123;
}
`)
    })

    it('$extend with nested', function() {
      var ret = cssobj({
        p:{
          span: {color:123}
        },
      ...
      expect(ret.css).equal(`p span,div {
color: 123;
}
`)
    })

    it('multi $extend with nested', function() {
      var ret = cssobj({
        p:{
          'b,span': {color:123}
        },
        'dd,div':{$extend: ['p span']}
      })
      expect(ret.css).equal(`p b,p span,dd,div {
color: 123;
}
`)
    })

    it('multi $extend with nested, multiple value', function() {
      var ret = cssobj({
        p:{
          color: 45,
          'b,span': {color:123}
        },
        'dd,div':{$extend: ['p span', 'p b', 'p']}
      })
      expect(ret.css).equal(`p,dd,div {
color: 45;
}
p b,p span,dd,div,dd,div {
color: 123;
}
`)
    })

    it('$extend with RegExp test', function() {
      var ret = cssobj({
        pp:{color: 78},
        p:{
          color: 45,
      ...
      expect(ret.css).equal(`pp {
color: 78;
}
p,div {
color: 45;
}
p b,p span,div b,div span {
color: 123;
}
`)
    })
